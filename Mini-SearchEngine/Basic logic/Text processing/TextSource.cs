...
namespace Mini_SearchEngine
{
    public static class TextSource
    {
        ...
        public static string? FromFile(string path)
        {
            ...
            // Изменяем путь, убирая из него кавычки и изменяя слеши, чтобы просчитать файл и достать из него текст.
        ...
        /// <summary>
        /// Возвращает входную строку, нужен для архитектуры при работе других классов.
        /// </summary>
